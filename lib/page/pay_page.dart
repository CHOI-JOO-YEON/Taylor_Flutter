...
class _PayPageState extends State<PayPage> {
        ...
        itemBuilder: (BuildContext context, int index) {
          return Padding(
            ...
            child: Container(
              ...
              width: menuWidth,
              decoration: BoxDecoration(
                color: orders[index].temp.contains('HOT')
                    ? Color(0xffFDACAB)
                    : Color(0xffC9D5FB),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                            padding:
                                EdgeInsets.symmetric(vertical: menuHeight / 6)),
                        Text(orders[index].price.toString() + '원',
                            style: TextStyle(fontSize: 16),
                            textAlign: TextAlign.center),
                      ],
                    ),
  ...
  Future<void> httpSend() async {
    orders[0].age = Attribute().age;
    orders[0].gender = Attribute().gender;
    // String json =jsonEncode(orders);
    // print(json);
    // print(jsonEncode(orders.map((e) => e.toJson())).toString());
    OrderApi(orders);
